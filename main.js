(function(){
  ...
  "Розширювачі зон":[
    ...
    { name:"M-ZP box",  img:"assets/modules/M-ZP box.png", normal:200, alarm:200 },
  ...
  "Панелі індикації":[
    ...
    sensors:[
      { name:"Swan Quad", img:"assets/sensors/swan quad.png", normal:8, alarm:10 },
      { name:"Swan PGB", img:"assets/sensors/swan pgb.png",  normal:16, alarm:22 },
      { name:"GBD II", img:"assets/sensors/gbd 2.png", normal:22, alarm:26 },
      { name:"SRPG II", img:"assets/sensors/srpg 2.png", normal:16, alarm:22 },
      { name:"SRP 600", img:"assets/sensors/srp 600.png", normal:8, alarm:8 },
